      ...
      <div className="max-w-md mx-auto px-4 py-12">
        <div className="bg-white border border-[#DEE3DE] rounded-xl p-8 shadow-subtle space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-[#68716A]">Willkommen zurück! Melde dich in deinem Konto an.</p>
          </div>
          ...
          <div className="text-center pt-2 text-xs text-[#68716A]">
            Noch kein Konto?{' '}
            <Link href="/registrieren" className="font-bold text-[#17A673] hover:underline">
